...
public class JogoDaVelha {
    ...
    public static void main(String[] args) {
        ...
        while(i < j){
            ...
            if (((m[0][0].equals(m[1][0])) && (m[1][0].equals(m[2][0]))) ^ (((m[0][1].equals(m[1][1])) && (m[1][1].equals(m[2][1])))) ^ (((m[0][2].equals(m[1][2])) && (m[1][2].equals(m[2][2])))) ^ (((m[0][0].equals(m[1][1])) && (m[1][1].equals(m[2][2])))) ^ (((m[0][2].equals(m[1][1])) && (m[1][1].equals(m[2][0])))) ^ (((m[1][2].equals(m[1][1])) && (m[1][1].equals(m[2][0])))) ^ (((m[0][0].equals(m[0][1])) && (m[0][1].equals(m[0][2])))) ^ (((m[1][0].equals(m[1][1])) && (m[1][1].equals(m[1][2])))) ^ (((m[2][0].equals(m[2][1])) && (m[2][1].equals(m[2][2]))))) {  
                j = i;
                System.out.println("========================");
                System.out.println("     JOGO DA VELHA      ");
                System.out.println("========================");
